...
import { calculateSpreadsheetChecksum, getRowDiff } from "./day2";
describe('Day 2', () => {
  
  it('should calculate checksum correctly', () => {
    expect(calculateSpreadsheetChecksum(`5 1 9 5
      7 5 3
      2 4 6 8`)).toEqual(18);

    expect(calculateSpreadsheetChecksum(`5 1 5
      7 3
      2 4 8`)).toEqual(14);
  });
  
  
  it('should calculate rowdiff correctly', () => {
    expect(getRowDiff('5 1 9 5')).toEqual(8);
    expect(getRowDiff('      7 5 3')).toEqual(4);
    expect(getRowDiff('2 4 6 8')).toEqual(6);
    
    expect(getRowDiff('5 1 5')).toEqual(4);
    expect(getRowDiff('7 3')).toEqual(4);
    expect(getRowDiff('2 4 8')).toEqual(6);
    
    expect(getRowDiff(`114	605	94	136	96	167	553	395	164	159	284	104	530	551	544	18`)).toEqual(587);
  });

  
  it('should match puzzle input', () => {
    const input = `278	1689	250	1512	1792	1974	175	1639	235	1635	1690	1947	810	224	928	859
